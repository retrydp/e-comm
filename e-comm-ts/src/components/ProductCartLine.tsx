...
const ProductCartLine = (): JSX.Element => {
  return (
    <div className="goods-line">
      <div className="goods-line__cart">
        <img src={nike} alt="" className="goods-line__img" />
        <div className="goods-line__inner">
          ...
          <div className="goods-line__info">
      ...
      <div className="goods-line__cart hot">
        ...
        <div className="goods-line__inner">
          ...
          <div className="goods-line__info">
            Nunc facilisis sagittis ullamcorper. Proin lectus ipsum, gravida et mattis vulputate, tristique ut lectus. Sed et lectus lorem nunc leifend laorevtr istique et congue. Vivamus adipiscin
